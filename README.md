About genutil-feedstock
=======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/genutil-feedstock/blob/main/LICENSE.txt)
      ...
      <details>
        <summary>
          <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3916&branchName=main">
            <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/genutil-feedstock?branchName=main">
          </a>
        </summary>
        <table>
          ...
          <tbody><tr>
              ...
              <td>
                <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3916&branchName=main">
                  <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/genutil-feedstock?branchName=main&jobName=linux&configuration=linux%20linux_64_numpy1.22python3.9.____73_pypy" alt="variant">
                </a>
              </td>
            </tr><tr>
              ...
              <td>
                <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3916&branchName=main">
                  <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/genutil-feedstock?branchName=main&jobName=osx&configuration=osx%20osx_64_numpy1.22python3.9.____73_pypy" alt="variant">
                </a>
              </td>
            </tr><tr>
...
Once the `conda-forge` channel has been enabled, `genutil` can be installed with `conda`:
...
```
mamba install genutil
```

It is possible to list all of the versions of `genutil` available on your platform with `conda`:
...
```
mamba search genutil --channel conda-forge
```
...
mamba repoquery search genutil --channel conda-forge

# List packages depending on `genutil`:
mamba repoquery whoneeds genutil --channel conda-forge

# List dependencies of `genutil`:
mamba repoquery depends genutil --channel conda-forge
```
